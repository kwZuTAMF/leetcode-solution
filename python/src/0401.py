class Solution:
    ...
    #     counts = [i.bit_count() for i in range(60)]
    #     return [f'{h}:{m:>02}' for h in range(12) for m in range(60) if counts[h] + counts[m] == turnedOn]
    ...
    def readBinaryWatch(self, turnedOn: int) -> list[str]:
        match turnedOn:
            ...
            case 2: return ['0:03', '0:05', '0:06', '0:09', '0:10', '0:12', '0:17', '0:18', '0:20', '0:24', '0:33', '0:34', '0:36', '0:40', '0:48', '1:01', '1:02', '1:04', '1:08', '1:16', '1:32', '2:01', '2:02', '2:04', '2:08', '2:16', '2:32', '3:00', '4:01', '4:02', '4:04', '4:08', '4:16', '4:32', '5:00', '6:00', '8:01', '8:02', '8:04', '8:08', '8:16', '8:32', '9:00', '10:00']
...
if __name__ == '__main__':
    ...
    class Test(unittest.TestCase):
        def test(self):
            readBinaryWatch = Solution().readBinaryWatch
            for turnedOn, excepted in CASES:
    ...
    readBinaryWatch = Solution().readBinaryWatch
    for turnedOn, _ in CASES:
        print(timeit(lambda: readBinaryWatch(turnedOn), number=100000))
